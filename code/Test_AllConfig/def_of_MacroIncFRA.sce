...
test_fra_macro.SystemOpt_Resol = ['SystemOpt_Static_neokeynesien_services'];
...
test_fra_macro.Scenario = ['AMSrun3mixnote'];//'AMErun3dgtnote'
...
test_fra_macro.with_sufficiency_behaviour = ['False', "Construction X Chauffage X Gaspillage alimentaire X Achat vehicules neufs X Deplacements X OthEq X Electromenager X OtherManufacturedGoods"];
...
// test_fra_macro.VAR_sigma_M = ['note'];
//test_fra_macro.VAR_sigma_omegaU = ["-0.1", "-3.6", "-0.01"];
//test_fra_macro.VAR_sigma_omegaU = ["-0.1","-0.6","-1.2","-1.8","-2.4","-3.0","-3.6"];
// test_fra_macro.VAR_sigma_omegaU = ["-0.1","-3.6"];
// test_fra_macro.VAR_sigma_omegaU = ["-0.05","-0.1","-0.15","-1.8"];
// test_fra_macro.Proj_scenario = ['sx1','sx2','sx3','sx4','sx5','sx6','sx7','sx8','sx9','sx10','sx11','sx12','sx13','sx14','sx15','sx16','sx17','sx18'];
// test_fra_macro.Proj_scenario = ['SNBC3_run3totalamsmixcjohanbis'];
